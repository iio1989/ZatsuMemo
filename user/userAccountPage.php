...
if (isset($_POST["new_user_show_id"])) {
    //登録する時の処理
    updateUser_idAndName($login_user_id, $_POST["new_user_show_id"], $_POST["new_user_name"]);
...
<body>
    ...
    <div class="user__account__form">
      <form class="form__id__name" method="post">
        ...
        <div>ユーザー名：<input type="text" class="form-control" name="new_user_name" placeholder="ユーザー名" value="<?php echo $login_user["user_name"]; ?>"></div>
