  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="memoListView.php" method="post">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="execSearchMemoPost('memoListView.php','searchMatchType','memoModalSearchText');">検索実行</button>
      </div>
    </div>
  </div>
</div>